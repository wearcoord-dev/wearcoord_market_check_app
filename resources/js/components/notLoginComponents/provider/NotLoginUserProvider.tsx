...
const NotLoginUserContext = createContext<NotLoginUserContextType>(
    {} as NotLoginUserContextType
);
    ...
    useEffect(() => {
        if (localStorage.getItem("flg")) {
            ...
            if (getUrlParam.get("brand")) {
                ...
                if (
                    getUrlParam.get("brand") !== localStorage.getItem("brand")
                ) {
