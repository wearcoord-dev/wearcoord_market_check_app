                        ...
                        <div class="form-group p-3">
                            ...
                            <div class="form-group p-3">
                                ...
                                <figure style="text-align: center; margin: 50px 0;">
                                    <img style="width: 30%; max-width: 250px;"
                                        src="{{'/img/showList/' . $detail->showImg}}" alt="">
                                </figure>
                                @endif
                            </div>
                            ...
                            <div class="bg-light">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                name="isShowSku" id="isShowOutsideApp" value="1" @if ($skuData &&
                                                $skuData->isShow
                                            == 1) checked @endif>
                                ...
                                <div class="row p-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                name="isShowDefaultWear" id="isShowDefaultWear" value="1" @if ($skuData
                                                && $skuData->isDefault
                                            == 1) checked @endif>
