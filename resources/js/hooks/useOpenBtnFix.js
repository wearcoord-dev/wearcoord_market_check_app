export const useOpenBtnFix = () => {
    ...
    const openBtnFix = () => {
        ...
        const btnSocksSummary = document.getElementById('btnSummarySocks');
        const btnShoesSummary = document.getElementById('btnSummaryShoes');
        const btnBandSummary = document.getElementById('btnSummaryBand');
        const btnInnerSummary = document.getElementById('btnSummaryInner');
        ...
        btnSocksSummary.onclick = function () {
            btnCaps.open = false;
            btnTops.open = false;
            btnPants.open = false;
            btnShoes.open = false;
        ...
        btnBandSummary.onclick = function () {
            btnCaps.open = false;
            btnTops.open = false;
            btnPants.open = false;
            btnSocks.open = false;
        ...
        btnInnerSummary.onclick = function () {
            btnCaps.open = false;
            btnTops.open = false;
            btnPants.open = false;
            btnSocks.open = false;
