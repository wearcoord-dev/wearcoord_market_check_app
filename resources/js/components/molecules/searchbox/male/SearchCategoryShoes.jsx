...
export const SearchCategoryShoes = memo((props) => {
    ...
    return (
        <>
            <div className="slide_x">
                ...
                <input type="radio" id="shoes" className="radioInput" name="category" value="208025" onChange={handleInputChange}
                checked={check.shoes}
                 />
